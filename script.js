...
const getRandomNumber = (num) => {return Math.floor(Math.random() * (num + 1));};
  ...
  noButton.addEventListener("click", () => {
    ...
    if (noClickCount < 4) {
      ...
      //no button text
      const messages = ["No","Are you sure?","Suni please?","Don't do this to me :(","Say yes or else...",];
  ...
  yesButton.addEventListener("click", () => {
    ...
    valentineQuestion.innerHTML = `
      <img src="./images/image7.jpeg" alt="Celebration duckie" style="display: block; margin: 0 auto; width: 200px; height: auto;"/>
      Congratulations!!<br>
